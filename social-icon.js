...
function SocialIcon(props) {
  ...
  return _react2.default.createElement(
    ...
    (0, _extends3.default)({}, rest, {
      href: url,
      target: '_blank',
      className: (0, _classnames2.default)('social-icon dib v-mid w2 h2 relative overflow-hidden', className),
      style: (0, _extends3.default)({}, props.style) }),
    _react2.default.createElement(
      'div',
      { className: 'social-container absolute top-0 left-0 w-100 h-100' },
      _react2.default.createElement(
        'svg',
        { fillRule: 'evenodd', className: 'social-svg absolute top-0 right-0 br-100 w-100 h-100', viewBox: '0 0 64 64' },
